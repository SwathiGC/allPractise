...
public class DummyReadOsgiConfigInfo {
    ...
    private void init() {
        ...
        try {
            ...
            String externalPathValue(Configuration confexternal){
            ...
            String justicePathValue(Configruation confjustice){
            ...
            String facsPathValue(Configuration conffacs){
